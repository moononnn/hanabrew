...
花酿不用再另开一个浏览器窗口了，它就长在 Hana 自己的界面里：左侧菜单点「花酿」，进去是完整的酒馆；卡片中心里还有一张「花酿 · 工作台」，角色来访、伙伴出口和试卡都从这里进入。

试卡那张是我最想让你用起来的。它不靠纸面推理猜你的卡有没有问题，而是把角色卡丢进真实酒馆跑一遍，让世界书、EJS、MVU 和已装扩展都按平时的流程参与进来，然后告诉你变量在哪一幕动了、哪一幕没动。

## 花酿在 Hana 里长什么样

<img src="docs/images/readme-01-card-center.png" alt="卡片中心里的「花酿 · 工作台」" width="720">

花酿在 Hana 新前端里有两个落点：

- **左侧菜单「花酿」**：完整 SillyTavern 整页。角色卡、原生聊天、世界书和酒馆自己的设置都归它管。
- **卡片中心「花酿 · 工作台」**：角色来访、伙伴出口和角色卡体检统一从这里进入，页面内再按功能切换。
...
小花会打开「花酿 · 工作台」里的卡片实验室，让你选择角色卡和测试重点。也可以直接从工作台进入；真正执行时仍由当前对话里的小花接手。
...
从「花酿 · 工作台」进入卡片实验室后，先选角色卡，再选「固定测卡」项目或「代笔对戏」。固定测卡适合检查 MVU、世界书、人设和边界等确定性问题；「代笔对戏」适合在真实角色回应里慢慢找感觉。如果你不想找卡片，也可以直接在当前对话说「帮我测一下这张角色卡」，小花会带你进入同一条流程。
...
| `tavern-open-theater` | 打开「花酿 · 工作台」里的卡片实验室，选择固定测卡或代笔对戏 |
